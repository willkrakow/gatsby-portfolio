...
const sections = [
  {
    textColumn: {
      ...
      title: 'Hi there!',
      description:
        "My name's Will. I'm a software engineer with a background in applied mathematics. These days I work mostly with TypeScript, React, Node, Docker, and AWS.",
    },
    cta: {
      label: 'View resume',
      link: '/resume',
  ...
  },
  {
    textColumn: {
      ...
      description:
        'Everything from frontend design concepts to fullstack applications and security vulnerability research.',
    },
    cta: {
